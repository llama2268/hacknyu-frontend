    ...
    <div className="min-h-screen bg-gradient-to-r from-green-300 to-blue-300 py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Saved Section */}
          <SectionCard title="Saved Recipes" description="Easily access and organize your favorite recipes for quick meal planning." />

          {/* History Section */}
          <SectionCard title="My History" description="Track your past meals and keep a history of your meal plans." />
        </div>
        ...
        {showForm && (
          <div className="mt-12 p-8 bg-white rounded-xl shadow-lg max-w-2xl mx-auto">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4">Generate a Custom Recipe</h2>
            <p className="text-gray-600 mb-6">Fill out the form to get a personalized recipe suggestion.</p>
            <form className="space-y-4">
              ...
              {/* Ingredients */}
              <div>
                <label className="block text-sm font-medium text-gray-700">Available Ingredients</label>
                <textarea
                  className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                  rows={4}
